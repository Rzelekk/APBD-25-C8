...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = Emps.Where(s => s.Job.Equals("Frontend programmer") && s.Salary > 1000).OrderByDescending(x => x.Ename);
            return result;
        }
        ...
        {
            IEnumerable<Emp> result = Emps.Where(e => e.Salary == Emps.Max(l => l.Salary));
            return result;
        }
        ...
        {
            IEnumerable<object> result = Emps.GroupBy(e => e.Job).Select(j => new {Praca = j.Key, LiczbaPracownikow = j.Count()});
            return result;
        }
        ...
        {
            Emp result = Emps.Where(s => s.Job == "Frontend programmer").OrderByDescending(e => e.HireDate).FirstOrDefault();
            return result;
        }
        ...
        public static IEnumerable<object> Task11()
        {
            IEnumerable<object> result = Emps
                    ...
                    .Select(e => new
                    {
                        name = Depts.FirstOrDefault(d => d.Deptno == e.Key)?.Dname ?? "Unknow",
        ...
        public static IEnumerable<Dept> Task14()
        {
            IEnumerable<Dept> result = Depts
                .GroupJoin(Emps,
                    d => d.Deptno,
                    e => e.Deptno,
                    (d, es) => new { Department = d, Employees = es })
                .Where(g => g.Employees.Count() == 5 || !g.Employees.Any())
                .OrderBy(g => g.Department.Dname)
    ...
    public static class CustomExtensionMethods
    {
        ...
        {
            return employees
                .Where(emp => employees.Any(sub => sub.Mgr?.Empno == emp.Empno))
